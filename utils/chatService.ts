...
export function subscribeToPresence(channelId: string, userId: string, userProfile: {
    username: string;
    avatar_url?: string
}, handler: (presenceState: Record<string, any[]>) => void): ChatSubscriptionHandle {
...
export function subscribeToTyping(channelId: string, handler: (evt: {
    type: string;
    record: any
}) => void): ChatSubscriptionHandle {
