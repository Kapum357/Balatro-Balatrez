  ...
  return (
    <View style={[styles.row, isOwn && styles.rowOwn]}>
      <View style={[styles.bubble, isOwn ? styles.bubbleOwn : styles.bubbleOther, deleted && styles.deleted]}> 
        ...
        <Text style={styles.meta}>{new Date(message.created_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</Text>
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  bubble: { maxWidth: '80%', borderWidth: 2, borderColor: Theme.colors.border, padding: Theme.spacing.xs, backgroundColor: Theme.colors.bgAlt },
